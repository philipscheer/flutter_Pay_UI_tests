...
class HomePageState extends State<HomePage> {
  final List<BankCardModel> cards = [
    BankCardModel('images/bg_red_card.png', 'Philip Scheer',
        '4221 5168 7464 2283', '08/20', 12000),
    BankCardModel('images/bg_blue_circle_card.png', 'Philip Scheer',
        '4221 5168 7464 2283', '08/20', 25000),
    BankCardModel('images/bg_purple_card.png', 'Philip Scheer',
        '4221 5168 7464 2283', '08/20', 85000),
    BankCardModel('images/bg_blue_card.png', 'Philip Scheer',
        '4221 5168 7464 2283', '08/20', 4900000),
  ];
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
              ...
              child: Text('Minhas contas e cartões')),
          Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child:
                              Text('Celular', style: TextStyle(fontSize: 12.0)),
                        )
                      ],
                    ),
                  ),
