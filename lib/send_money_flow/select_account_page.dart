...
class SelectAccountPageState extends State<SelectAccountPage> {
  ...
  List<ReceiverModel> receivers = [
    ReceiverModel('Marcio', '96135-3939', '1234 0000 0099 0909'),
    ReceiverModel('João', '96135-3939', '1234 0000 0099 0909'),
    ReceiverModel('Barbara', '96135-3939', '1234 0000 0099 0909'),
    ReceiverModel('Marcilio', '96135-3939', '1234 0000 0099 0909'),
    ReceiverModel('Antonio', '96135-3939', '5678 0000 0099 0909'),
  ];
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration.collapsed(
                hintText: 'Procurar por Telefone ou Pessoa',
              ),
